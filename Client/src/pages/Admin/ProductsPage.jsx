    ...
    <div className="p-4 md:p-6 space-y-6 max-w-7xl mx-auto w-full">
      ...
      >
        <button
          ...
          className={`p-4 sm:p-5 rounded-2xl text-left transition-all duration-200 cursor-pointer border flex items-center justify-between ${
            selectedFilter === "all"
        ...
        >
          <div className="space-y-1 min-w-0 pr-2">
            <p className="text-xs font-extrabold text-[#64748B] dark:text-gray-400 uppercase tracking-wider">Total Products</p>
            <h3 className="text-2xl sm:text-3xl font-black text-[#1E88E5] dark:text-blue-300">{totalProducts(safeProducts)}</h3>
            <span className="text-[11px] font-semibold text-[#1E88E5] dark:text-blue-400 block pt-0.5">
              {selectedFilter === "all" ? "✓ Active Filter" : "Click to view all"}
            </span>
          </div>
          <div className="w-12 h-12 rounded-2xl bg-blue-100 dark:bg-blue-900/60 flex items-center justify-center text-[#1E88E5] dark:text-blue-300 font-bold shrink-0 shadow-xs">
        ...
        >
          <div className="space-y-1 min-w-0 pr-2">
            <p className="text-xs font-extrabold text-[#64748B] dark:text-gray-400 uppercase tracking-wider">Low Stock Products</p>
            <h3 className="text-2xl sm:text-3xl font-black text-[#FB8C00] dark:text-amber-400">{lowStock}</h3>
            <span className="text-[11px] font-semibold text-[#FB8C00] dark:text-amber-400 block pt-0.5">
              {selectedFilter === "lowStock" ? "✓ Active Filter" : "Click to view low stock"}
            </span>
          </div>
          <div className="w-12 h-12 rounded-2xl bg-amber-100 dark:bg-amber-900/60 flex items-center justify-center text-[#FB8C00] dark:text-amber-400 font-bold shrink-0 shadow-xs">
        ...
        >
          <div className="space-y-1 min-w-0 pr-2">
            <p className="text-xs font-extrabold text-[#64748B] dark:text-gray-400 uppercase tracking-wider">Expiring Soon</p>
            <h3 className="text-2xl sm:text-3xl font-black text-[#E53935] dark:text-red-400">{expiringSoonCount}</h3>
            <span className="text-[11px] font-semibold text-[#E53935] dark:text-red-400 block pt-0.5">
              {selectedFilter === "expiringSoon" ? "✓ Active Filter" : "Click to view expiring soon"}
            </span>
          </div>
          <div className="w-12 h-12 rounded-2xl bg-red-100 dark:bg-red-900/60 flex items-center justify-center text-[#E53935] dark:text-red-400 font-bold shrink-0 shadow-xs">
