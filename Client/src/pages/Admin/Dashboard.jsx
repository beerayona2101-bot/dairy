...
export default function Dashboard() {
  ...
  return (
    ...
    >
      {/* Top 4 Interactive Metric Cards Grid */}
      <motion.div variants={fadeUpVariant} className="grid grid-cols-2 lg:grid-cols-4 gap-2.5 sm:gap-5">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.96 }}
          className="p-2.5 sm:p-5 md:p-6 rounded-xl sm:rounded-[24px] bg-white dark:bg-gray-800 border border-purple-100/80 dark:border-gray-700/80 shadow-[0_4px_20px_rgba(140,124,240,0.08)] hover:shadow-[0_12px_30px_rgba(140,124,240,0.18)] hover:border-[#8C7CF0] transition-all duration-300 cursor-pointer text-left flex flex-col justify-between group relative overflow-hidden min-h-[85px] sm:min-h-[135px]"
        >
          <div className="flex items-center justify-between w-full">
            <div className="w-6 h-6 sm:w-10 sm:h-10 rounded-md sm:rounded-2xl bg-purple-50 dark:bg-purple-950/60 text-[#8C7CF0] dark:text-purple-300 flex items-center justify-center shadow-xs border border-purple-200/60 dark:border-purple-800 shrink-0">
              <TrendingUpIcon className="text-xs sm:text-xl drop-shadow-xs" />
            </div>
            <ArrowForwardIcon className="text-[#8C7CF0] opacity-60 group-hover:opacity-100 group-hover:translate-x-1 transition-all text-[10px] sm:text-xl shrink-0" />
          </div>
          ...
          <div className="space-y-0.5 sm:space-y-1 mt-1 sm:mt-2.5">
            ...
            <div className="text-xs sm:text-2xl md:text-3xl font-black text-[#8C7CF0] dark:text-purple-300 tracking-tight truncate">
              &#8377;{formatNumberWithCommas(totalRevenue)}
            </div>
            <p className="text-[9px] sm:text-[11px] text-gray-400 dark:text-gray-400 font-bold truncate hidden sm:block">
        ...
        >
          <div className="flex items-center justify-between w-full">
            <div className="w-6 h-6 sm:w-10 sm:h-10 rounded-md sm:rounded-2xl bg-purple-50 dark:bg-purple-950/60 text-[#8C7CF0] dark:text-purple-300 flex items-center justify-center shadow-xs border border-purple-200/60 dark:border-purple-800 shrink-0">
              <ReceiptLongIcon className="text-xs sm:text-xl drop-shadow-xs" />
            </div>
            <ArrowForwardIcon className="text-[#8C7CF0] opacity-60 group-hover:opacity-100 group-hover:translate-x-1 transition-all text-[10px] sm:text-xl shrink-0" />
          </div>
        ...
        >
          <div className="flex items-center justify-between w-full">
            <div className="w-6 h-6 sm:w-10 sm:h-10 rounded-md sm:rounded-2xl bg-purple-50 dark:bg-purple-950/60 text-[#8C7CF0] dark:text-purple-300 flex items-center justify-center shadow-xs border border-purple-200/60 dark:border-purple-800 shrink-0">
              <StoreIcon className="text-xs sm:text-xl drop-shadow-xs" />
            </div>
            <ArrowForwardIcon className="text-[#8C7CF0] opacity-60 group-hover:opacity-100 group-hover:translate-x-1 transition-all text-[10px] sm:text-xl shrink-0" />
          </div>
        ...
        >
          <div className="flex items-center justify-between w-full">
            <div className="w-6 h-6 sm:w-10 sm:h-10 rounded-md sm:rounded-2xl bg-purple-50 dark:bg-purple-950/60 text-[#8C7CF0] dark:text-purple-300 flex items-center justify-center shadow-xs border border-purple-200/60 dark:border-purple-800 shrink-0">
              <Inventory2Icon className="text-xs sm:text-xl drop-shadow-xs" />
            </div>
            <ArrowForwardIcon className="text-[#8C7CF0] opacity-60 group-hover:opacity-100 group-hover:translate-x-1 transition-all text-[10px] sm:text-xl shrink-0" />
          </div>
