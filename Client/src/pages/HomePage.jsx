...
export default function HomePage() {
    ...
    return (
        <>
            ...
            {/* 3. Discover Our Delicious Dairy Range Carousel Section */}
            <section className="px-3 py-6 sm:px-6 md:py-10 max-w-7xl mx-auto">
                <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-center mb-6 text-[#2D3748] dark:text-white tracking-tight leading-tight">
            ...
            {/* 5. Our Goodness Grid Section */}
            <section className="py-16 px-4 md:px-10">
                <div className="text-center mb-12">
                    <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-[#2D3748] dark:text-white tracking-tight leading-tight">Our Goodness</h2>
