...
export default function OrdersOverview({ totalOrdersRecieved, totalPendingOrders, countCanceledOrders, countDeliveredOrders, loading }) {
  ...
  const purchaseOverviewData = [
    ...
    },
    {
      ...
      icon: <UndoIcon className="text-purple-600 dark:text-purple-300" />,
      bg: "bg-purple-100/70 hover:bg-purple-200/70 dark:bg-purple-900/40 dark:hover:bg-purple-900/60 border-purple-200 dark:border-purple-800/40",
      route: "/admin/orders",
    },
    {
      name: "Total Canceled",
      value: countCanceledOrders || 0,
      icon: <CancelIcon className="text-zinc-900 dark:text-zinc-300" />,
      bg: "bg-zinc-100/90 hover:bg-zinc-200/90 dark:bg-zinc-800/80 dark:hover:bg-zinc-700/80 border-zinc-300 dark:border-zinc-700",
      route: "/admin/orders",
    },
    {
      name: "Total Pending Orders",
      value: totalPendingOrders,
      icon: <Timer className="text-purple-700 dark:text-purple-300" />,
      bg: "bg-purple-50/90 hover:bg-purple-100/90 dark:bg-purple-950/40 dark:hover:bg-purple-950/60 border-purple-200 dark:border-purple-800/40",
      route: "/admin/orders",
    },
  ];
